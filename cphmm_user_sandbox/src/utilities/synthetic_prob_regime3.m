function synthetic_data = synthetic_prob_regime3(seq_length, kappa, K, w, ...
                             v, kon, koff_min, koff_max, deltaT, noise, pi0)
    ...
    R_const = [-2*kon,        koff_min,           0; ...
                2*kon,    -(kon+koff_min),   2*koff_min; ...
                0.000,        kon,      -2*koff_min];
    ...
    for t = (t_const + 1) : seq_length
        koff = koff_min + (koff_max-koff_min)*(t-t_const)/(seq_length - t_const);
